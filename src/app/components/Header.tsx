      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link
              href="/hotels"
              className={`px-3 py-2 rounded-lg text-sm lg:text-base font-medium transition ${
                pathname === "/hotels"
            ...
            {/* Sign-in button always styled */}
            <Link
              href="/signin"
              className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold transition px-4 py-2 rounded-lg shadow-md text-sm lg:text-base"
            >
              Sign in
            </Link>
          </nav>
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            {/* Language Icon */}
            <button
              className="p-2 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition duration-150 group"
            ...
            {/* Currency Icon */}
            <button
              className="p-2 text-gray-500 hover:text-green-600 hover:bg-green-50 rounded-full transition duration-150"
            ...
            {/* Notification Icon */}
            <button
              className="relative p-2 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-full transition duration-150"
              title="Notifications"
            >
      ...
      {isMenuOpen && (
        <nav className="md:hidden bg-white border-t border-gray-100 shadow-inner">
          <div className="py-2 px-4 sm:px-6 space-y-1">
            <Link
              href="/hotels"
              className="block text-gray-700 hover:bg-gray-50 hover:text-indigo-600 font-medium py-3 px-2 rounded-lg transition duration-150"
            >
              Hotels
            </Link>
            <Link
            ...
            <Link
              href="/signin"
              className="block text-indigo-700 hover:bg-indigo-50 hover:text-indigo-900 font-bold py-3 px-2 rounded-lg transition duration-150"
            >
              Sign in
            </Link>
          </div>
